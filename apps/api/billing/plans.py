...
PLAN_DEFINITIONS: dict[PlanTier, PlanDefinition] = {
    ...
    PlanTier.ENTERPRISE: PlanDefinition(
        ...
        features=[
            ...
            PlanFeature("Daily continuous monitoring", True),
            PlanFeature("All report formats + SOC 2 evidence packs", True),
            PlanFeature("Email + webhook + Slack alerts", True),
            PlanFeature("VirusTotal + URLhaus enrichment", True),
            PlanFeature("15 team seats", True),
            PlanFeature("Full API access (read + write)", True),
