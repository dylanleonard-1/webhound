...
const CARD_FEATURES: Record<PlanTier, string[]> = {
  ...
  shield: [
    'Everything in Pro',
    'More frequent scans (daily)',
    'Deeper analysis (deep profile)',
    'Expanded third-party risk detection',
    'Priority alerts',
...
const COMPARE: { category: string; rows: { label: string; cells: [Cell, Cell, Cell, Cell] }[] }[] = [
  {
    ...
    rows: [
      ...
      { label: 'Scan frequency',         cells: ['Manual', 'Weekly', 'Daily', 'Daily'] },
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Instead of one snapshot, WebHound rescans your site on a schedule (weekly on Pro, daily on Shield and Managed Review). When something new shows up — a new finding, a regression, an expired cert — we tell you.',
  },
  {
  ...
  },
  {
    ...
    a: 'Free is manual only. Pro rescans weekly, Shield and Managed Review rescan daily. You can also kick off ad-hoc scans anytime up to your monthly limit.',
  },
  {
