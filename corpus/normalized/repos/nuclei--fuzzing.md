...
- workdir: `/.gofuzz/`
- seed corpus: `/testdata/gofuzz-corpus/`
- instrumented archive: `/.gofuzz/-fuzz.zip`
...
- Artifacts: each matrix job uploads the full `/.gofuzz/` as the artifacts.
